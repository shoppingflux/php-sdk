<?php
namespace ShoppingFeed\Sdk\Test\Http;

use PHPUnit\Framework\TestCase;
use ShoppingFeed\Sdk\Http\UriTemplate;

#[\PHPUnit\Framework\Attributes\CoversClass(\ShoppingFeed\Sdk\Http\UriTemplate::class)]
class UriTemplateTest extends TestCase
{
    ...
    public static function templateProvider()
    {
        ...
        return array_map(function ($t) use ($params) {
            ...
            array('http://www.test.com{+path}{?var,keys*}',
    ...
    #[\PHPUnit\Framework\Attributes\DataProvider('expressionProvider')]
    ...
    // See: https://github.com/guzzle/guzzle/issues/90
    public function testAllowsNestedArrayExpansion()
    {
        ...
        $this->assertEquals(
            'http://example.com/foo/bar/one,two?query=test&more%5B0%5D=fun' .
            '&more%5B1%5D=ice%20cream&baz%5Bbar%5D=fizz&baz%5Btest%5D=buzz&bam=boo', $result);
    }
}